...
import { SeperatorDot } from '@website/components/shared/SeperatorDot';
import { UserAvatar } from '@website/components/shared/UserAvatar';
import { cn } from '@website/utils/cn';
import { Seperator } from '@website/components/shared/Seperator';
    ...
    >
      ...
      <div className="ml-2 mt-2 flex w-full flex-wrap gap-1">
        ...
        {page.badges.map((badge) => {
          return (
            <Badge variant={badge.name} ignoreIcon={badge.name === 'admin'} />
          );
        })}
      </div>
